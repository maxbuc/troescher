 ...
 * @author Maximilian
 */
@WebServlet(name = "CtrlSelectGenre", urlPatterns = {"/ctrlselectgenre"})
public class CtrlSelectGenre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "select name from genre order by gid";
        ...
        RequestDispatcher view = request.getRequestDispatcher("genreinsert.jsp");
