 ...
 * @author Maximilian
 */
@WebServlet(name = "CtrlGenreInsert", urlPatterns = {"/ctrlgenreinsert"})
public class CtrlGenreInsert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("ctrlselectgenre");
